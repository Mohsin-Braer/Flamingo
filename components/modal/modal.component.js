                                        ...
                                        <div className="mt-7 flex space-x-3 w-full">
                                            ...
                                            <div className="flex-grow mt-2">
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <button className="bg-[#e64088] text-white rounded-full px-4 py-1.5 font-bold shadow-md hover:bg-[#e82378] disabled:hover:bg-[#ee79ac] disabled:opacity-50 disabled:cursor-default"
                                                            type="submit"
                                                            onClick={sendComment}
